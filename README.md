...
ALOS_PS:	Line-of-sight acceleration, assuming MODEL_PSDOT_B is correct. The Shklovskii term has already been removed from this value. (mm/s/yr = cm/s/decade)
ALOS_PS_ERR:	Uncertainty in ALOS_PS
...
PBDOT_SHK_ERR:	Uncertainty in PBDOT_SHK
...
ALOS_PB:	Line-of-sight acceleration, calculated using the binary orbital period data. (In most cases, use this over ALOS_PS if available, but consult ALOS_PS_ERR and ALOS_PB_ERR)
ALOS_PB_ERR:	Uncertainty in ALOS_PB
